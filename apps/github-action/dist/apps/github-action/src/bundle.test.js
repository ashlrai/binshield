...
describe("github action bundle", () => {
    it("ships a self-contained runtime entrypoint", () => {
        const bundle = readFileSync(resolve(dirname(fileURLToPath(import.meta.url)), "../dist/index.cjs"), "utf8");
    ...
    it("declares the CommonJS bundle as the action entrypoint", () => {
        const manifest = readFileSync(resolve(dirname(fileURLToPath(import.meta.url)), "../action.yml"), "utf8");
